...
class Outcome(BaseModel):
    ...
    # Celebration image (generated by Nano Banana)
    celebration_image: Optional[str] = Field(
        None,
        description="Base64 encoded celebration/encouragement image"
    )
    celebration_image_type: Optional[str] = Field(
        None,
        description="Type of image: celebration, encouragement, streak_milestone, goal_complete"
    )
    celebration_image_grade: Optional[str] = Field(
        None,
